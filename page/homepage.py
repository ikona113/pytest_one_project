...
class HomePage:
    ...
    def click_galaxy_s6(self):
        galaxy_s6 = self.driver.find_element(By.XPATH, "//a[text()='Samsung galaxy s6']")  ### Найти элемент ссылка которого имеет текст = Samsung galaxy s6
    ...
    def check_products_count(self, count):
        monitors = self.driver.find_element(By.CSS_SELECTOR, '.card')
